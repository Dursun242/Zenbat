  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,.6)", zIndex: 999, display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}>
      <div style={{ background: "#fff", borderRadius: 20, padding: 32, maxWidth: 480, width: "100%", boxShadow: "0 20px 60px rgba(0,0,0,.2)" }}>
        ...
        <h2 style={{ fontSize: 20, fontWeight: 800, color: "#1A1612", marginBottom: 8 }}>
          Mise à jour des CGU
        </h2>
        <p style={{ fontSize: 14, color: "#6B6358", lineHeight: 1.7, marginBottom: 24 }}>
        ...
        <div style={{ display: "flex", gap: 10 }}>
          <button onClick={handleRefuse}
            style={{ flex: 1, padding: "12px 0", border: "1px solid #E8E2D8", borderRadius: 12, background: "#fff", color: "#6B6358", fontSize: 14, fontWeight: 600, cursor: "pointer" }}>
            Refuser & se déconnecter
          </button>
          <button onClick={handleAccept} disabled={loading}
            style={{ flex: 1, padding: "12px 0", border: 0, borderRadius: 12, background: "#1A1612", color: "#fff", fontSize: 14, fontWeight: 700, cursor: loading ? "not-allowed" : "pointer", opacity: loading ? 0.6 : 1 }}>
