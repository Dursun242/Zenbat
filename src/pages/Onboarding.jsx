          ...
          <div className="pop" style={{display:"flex",flexDirection:"column",gap:16}}>
            ...
            <div style={{background:"#1e293b",border:"1px solid #334155",borderRadius:14,padding:16}}>
              ...
              <button onClick={exportMyData} disabled={exportBusy}
                style={{width:"100%",background:exportBusy?"#334155":"#22c55e",color:exportBusy?"#94a3b8":"white",border:"none",borderRadius:12,padding:"11px",fontSize:13,fontWeight:700,cursor:exportBusy?"not-allowed":"pointer"}}>
            ...
            {/* Suppression compte */}
            <div style={{background:"#1e293b",border:"1px solid #7f1d1d",borderRadius:14,padding:16}}>
              <div style={{display:"flex",alignItems:"flex-start",gap:12,marginBottom:10}}>
            ...
            <div style={{fontSize:10,color:"#64748b",lineHeight:1.6,padding:"0 4px"}}>
              💡 Vous pouvez aussi exercer vos autres droits RGPD (rectification, limitation, opposition, plainte CNIL) en écrivant à <span style={{color:"#94a3b8"}}>Zenbat76@gmail.com</span>.
            </div>
          </div>
        )}
