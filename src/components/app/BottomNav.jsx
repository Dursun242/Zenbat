...
export default function BottomNav({ items, activeNav, onSelect, plan, daysLeft }) {
  return (
    <nav className="app-bottom-nav" style={{ position: "fixed", bottom: 0, left: 0, right: 0, background: "#1A1612", borderTop: "1px solid rgba(255,255,255,.06)", display: "flex", zIndex: 50, paddingBottom: "min(env(safe-area-inset-bottom), 16px)" }}>
