...
// le navigateur lève "Importing a module script failed" (Safari),
// "Failed to fetch dynamically imported module" (Chrome), etc.
// Voir src/lib/chunkReload.js pour la logique (nettoyage SW + caches + reload).
//
// NB : ces handlers globaux ne rattrapent PAS les erreurs venant de
// `lazy(() => import(...))`, que React capture en interne et propage vers
// l'ErrorBoundary. La récupération est aussi câblée côté ErrorBoundary.
